<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="UserAccount.aspx.cs" Inherits="OrderSystem.Account.UserAccount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div >
            <dx:BootstrapGridView ID="grid" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="ID" OnBatchUpdate="grid_BatchUpdate" OnInitNewRow="grid_InitNewRow" OnRowDeleting="grid_RowDeleting" OnRowInserting="grid_RowInserting" OnRowUpdating="grid_RowUpdating">
                ...
                <SettingsText Title="USER ACCOUNT PROFILE" />
                ...
                <Columns>
                    ...
                    <dx:BootstrapGridViewTextColumn Caption="PASSWORD" FieldName="PWord" VisibleIndex="2">
                        <PropertiesTextEdit Password="True">
                        </PropertiesTextEdit>
                    </dx:BootstrapGridViewTextColumn> 
                     <dx:BootstrapGridViewTextColumn Caption="NAME" FieldName="Name" VisibleIndex="3">
                    </dx:BootstrapGridViewTextColumn>
                     <dx:BootstrapGridViewComboBoxColumn Caption="TYPE" FieldName="UserType" VisibleIndex="4">
                        <PropertiesComboBox>
                            <Items>
                    ...
                    <dx:BootstrapGridViewComboBoxColumn Caption="STATUS" FieldName="Status" VisibleIndex="5">
                        <PropertiesComboBox>
                            <Items>
                    ...
                    <dx:BootstrapGridViewDateColumn Caption="UPDATED" FieldName="UpdateDate" VisibleIndex="8">
                    </dx:BootstrapGridViewDateColumn>
                    <dx:BootstrapGridViewTextColumn Caption="UPDATED BY" FieldName="UpdateBy" VisibleIndex="9">
                    </dx:BootstrapGridViewTextColumn>
                    <dx:BootstrapGridViewDateColumn Caption="CREATED" FieldName="CreateDate" VisibleIndex="6">
                    </dx:BootstrapGridViewDateColumn>
                    <dx:BootstrapGridViewTextColumn Caption="CREATED BY" FieldName="CreateBy" VisibleIndex="7">
                    </dx:BootstrapGridViewTextColumn>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [UserAcct]"></asp:SqlDataSource>
        </div>
