<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"  AutoEventWireup="true" CodeBehind="ResellerProfile.aspx.cs" Inherits="OrderSystem.Master.ResellerProfile" %>
    ...
    <script>
        function OnBatchEditStartEdit(s, e) {
            if (e.visibleIndex < 0) {//new mode
                var editor = s.GetEditor("ResellerCode"); if (editor != null) editor.SetEnabled(true);
                return;
            }
            var editor = s.GetEditor("ResellerCode"); if (editor != null) editor.SetEnabled(false);
        ...
        <div >
           <dx:BootstrapGridView ID="grid" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="ID" OnBatchUpdate="grid_BatchUpdate" OnInitNewRow="grid_InitNewRow" OnRowDeleting="grid_RowDeleting" OnRowInserting="grid_RowInserting" OnRowUpdating="grid_RowUpdating">
               ...
               <CssClasses HeaderRow="headerRow" />
                ...
                <SettingsText Title="RESELLER PROFILE" />
                ...
                <Columns>
                    ...
                    <dx:BootstrapGridViewTextColumn Caption="CODE" FieldName="ResellerCode" VisibleIndex="2" Width="100px">
                    ...
                    <dx:BootstrapGridViewTextColumn Caption="NAME" FieldName="ResellerName" VisibleIndex="3" Width="250px">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Reseller]"></asp:SqlDataSource >
        </div >
